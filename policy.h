/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: Mon 02 May 2016 12:17:29 AM JST
 ************************************************************************/
...
#define COMPUTE_RATE_TIMRE 10           // 每隔１０秒计算一次各个peer的下载和上传速度
...
void int_unchoke_peers();                   // 初始化plicy.c中定义的全局变量unchoke_peers
