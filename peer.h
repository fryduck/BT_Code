/*************************************************************************
	> File Name: peer.htfield.h
	> Author: 
	> Mail: 
	> Created Time: 2015年11月09日 星期一 22时01分17秒
 ************************************************************************/
...
typedef struct _Peer{
    ...
    float down_rate;                  // 本计时周期从peer下载的数据的速度
    float up_rate;                    // 本计时周期向peer上传的数据的速度
